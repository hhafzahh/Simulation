                ...
                if(alertText == "Created"){
                    ...
                    if(numRowsAfter = numRows + 1){
                        ...
                        driver.findElement(By.xpath("/html/body/app-root/app-home/div[2]/table/tbody/tr[last()]/td[9]/button")).click().then(async found => {
                            ...
                            // }catch(error){
                            //     console.log("Delete Issue test: Failed! Reason:" + error);
                            //     }
                            ;
...
//             console.log("Launch test: Passed!");
//             //Get number of rows
//             driver.findElement(By.xpath("html/body/app-root/app-home/div[2]/table/tbody/tr")).then(function(tableRows){
//                 let numRows = tableRows.length
//             //console.log("no of tableRows :",numRows)
...
//                                     }
//                                 } catch(err){
//                                     console.log("Update Issue test: Failed! Reason:" + err);
//                                 }
//                                 });
